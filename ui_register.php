        ...
        <div class="column is-4 is-offset-4">
          ...
          <div class="box">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
              <div class="field">
                <div class="control">
                  <input class="input is-large" name="email" type="email" placeholder="您的電子郵件信箱" autofocus="">
                </div>
              </div>
              ...
              <div class="field">
                <div class="control">
                  <input class="input is-large" name="confirm_password" type="password" placeholder="請再輸入一次密碼">
                </div>
              </div>
