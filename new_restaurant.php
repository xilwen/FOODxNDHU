      ...
      <div class="container has-text-centered">
        <div class="column is-4 is-offset-4">
          ...
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
              <div class="field">
                <div class="control">
                  <input class="input is-large" name="restaurant_name" type="text" placeholder="店家名稱(必填)" autofocus="">
                </div>
              </div>

              <div class="field">
                <div class="control">
                  <input class="input is-large" name="restaurant_address" type="text" placeholder="地址(必填)">
                </div>
              </div>
              ...
              <div class="field">
                <div class="control">
                  <input class="input is-large" name="restaurant_fbpage" type="text" placeholder="Facebook">
                </div>
              </div>

              <div class="field">
                <div class="control">
                  <input class="input is-large" name="restaurant_lineid" type="text" placeholder="LINE ID">
                </div>
              </div>
